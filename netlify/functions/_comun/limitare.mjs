...
export const MAX_ESECURI = 8;          // încercări greșite permise…
export const FEREASTRA_MS = 15 * 60e3; // …într-un sfert de oră
export const BLOCARE_MS = 15 * 60e3;   // cât ține blocarea după depășire
...
export async function verificaLimita(cheie) {
  try {
    ...
    const acum = Date.now();
    if (r.blocatPana && r.blocatPana > acum)
