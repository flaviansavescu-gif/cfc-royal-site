...
export const mainNav: NavItem[] = [
  { slug: "", label: { ro: "Acasă", en: "Home" } },
  {
    ...
    children: [
      ...
      { slug: "organizatia/arbitri", label: { ro: "Corpul de arbitri", en: "Panel of judges" } },
      { slug: "organizatia/canise", label: { ro: "Canise înregistrate", en: "Registered kennels" } },
      { slug: "organizatia/membri-onoare", label: { ro: "Membri de onoare", en: "Honorary members" } },
